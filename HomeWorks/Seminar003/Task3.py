...
string = [i for i in input('Введите слово: ').upper()]

if N == 1:
    print('За это слово вы получаете', sum(
        [k for i in string for k, v in slov_en.items() if i in v]), 'очков')
elif N == 0:
    print('За это слово вы получаете', sum(
        [k for i in string for k, v in slov_ru.items() if i in v]), 'очков')
else:
